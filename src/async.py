...
#     CREATE TABLE IF NOT EXISTS Gardenia (
#         name TEXT,
#         link TEXT,
#         category TEXT
#     );
#     CREATE TABLE IF NOT EXISTS GardeniaDetails (
#         id TEXT,
#         prescription TEXT
#     );
...
#         category TEXT
#     );
#     CREATE TABLE IF NOT EXISTS EDSDetails (
#         id TEXT,
#         prescription TEXT
#     );
# """)
# def insertDrug(table, tup):
#     print(f"INSERT INTO {table} VALUES {str(tup)}")
#     cursor.execute(f"INSERT INTO {table} VALUES {str(tup)}")
#######################################
